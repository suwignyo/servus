                ...
                <div className="service-box-container">
                    <div
                        className={`service-box worship ${
                            this.state.serviceActive.placeOfWorship
                                ? "service-selected"
                                : ""
                        }`}
                        onClick={() =>
                    ...
                    <div
                        className={`service-box temples ${
                            this.state.serviceActive.temples
                                ? "service-selected"
                                : ""
                        }`}
                    ...
                    <div
                        className={`service-box markets ${
                            this.state.serviceActive.localMarkets
                                ? "service-selected"
                                : ""
                        }`}
                        onClick={() =>
                ...
                <div className="service-box-container">
                    <div
                        className={`service-box doctors ${
                            this.state.serviceActive.doctors
                                ? "service-selected"
                                : ""
                        }`}
                    ...
                    <div
                        className={`service-box lawyers ${
                            this.state.serviceActive.lawyers
                                ? "service-selected"
                                : ""
                        }`}
                    ...
                    <div
                        className={`service-box accountants ${
                            this.state.serviceActive.accountants
                                ? "service-selected"
                                : ""
                        }`}
